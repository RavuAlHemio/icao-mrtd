//! Standardized Diffie-Hellman parameters.
//!
//! Taken from [RFC5114](https://datatracker.ietf.org/doc/html/rfc5114) as referenced in ICAO
...
pub fn get_1024_modp_160_po() -> DiffieHellmanParams {
    DiffieHellmanParams {
        prime: boxed_uint_from_be_slice(&hex!("
            ...
            DF1FB2BC 2E4A4371
        ")),
        generator: boxed_uint_from_be_slice(&hex!("
...
pub fn get_2048_modp_224_po() -> DiffieHellmanParams {
    DiffieHellmanParams {
        prime: boxed_uint_from_be_slice(&hex!("
...
pub fn get_2048_modp_256_po() -> DiffieHellmanParams {
    DiffieHellmanParams {
        prime: boxed_uint_from_be_slice(&hex!("
